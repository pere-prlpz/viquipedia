...
for artwd in artwds:
    ...
    if item.claims:
        ...
        if artwd in artsnaix and 'P569' in item.claims:
            ...
            elif len(qualificadors-{"P31","P7452","P4241","P3629","P509"})>0:
            ...
            1201, 1202,1203, 1204, 1206, 1207, 1211,1212,1213, 1214, 1217, 1218,1219,1221, 1223,1225, 1227, 1231,1232,1234, 1235, 
        ...
        if artwd in artsmort and 'P570' in item.claims:
            ...
            if len(set(anys))>1:
                ...
                ierrdesat = ierrdesat+1
            elif anys[0] < 1013 and anys[0] not in [14,17,23,32,33,36,37,38,42,47,48,54,59,62,65,66,68,69,79,96,
            118,182,184,189,191,192,193,197,199,
            ...
            406,407,411,412,413,449,453,474,484,498,
            514,534,547,548,565,572,574,581,584,590,593,597,599, 
            602,624,627,629,631,632,636,638,641,642,647,652,653,654,657,658,
            662,664,672,673,676,679,683,685,686,687,689,692,695,697,
            705,706,707,714,715,716,717,718,719,721,725,732,737,738,
            741,743,744,748,754,756,761,762,767,768,769,783,784,786,787,
            ...
            952,954,955,956,957,958,961,962,963,965,966,967,968,970,971,972,973,975,976,977,978,979,
            981, 987,989,983,984,985,988,
            990,991,992,993,994,995,997,998,999,1000,1003,1004,1005,1008, 1009, 
            1010,1011,1012,1014,1015,1016,1017,1018,1019,1020,1021,1022,1023]:
                nany = anys[0]
                print("Massa antic per tenir categoria", ierrdesat)
